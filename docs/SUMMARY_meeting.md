...
> **참고 — "실제 영상을 더 모으면?"(배찬우 팀원 제안, Roboflow 등)**: 실제 화재 영상을 추가하면 위 불확실성을 줄여 *아주 작은 차이*까지 가릴 수 있다. 유효한 다음 수였지만 **실행하지 않았다** — ① 이후 v3에서 최신 모델(DINOv3)조차 개선 폭이 기준에 못 미쳐, **영상을 더 모아 정밀하게 재도 "불꽃/표현이 답"이라는 결론은 안 바뀜**(실익 낮음). ② 우리 도메인(급식실 유류화재)에 맞고 **헷갈리는 무화재 장면까지 갖춘** 실제 영상 확보가 어려움. → 병목이 데이터/도메인으로 좁혀진 지금은 **영상 확장보다 방향 전환이 우선.**
